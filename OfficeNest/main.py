...
class MotherApp:
    ...
    def __init__(self, config_path: str = "config/default.yaml"):
        ...
        # 知识库
        use_ds_embed = getattr(self.cfg.llm, 'kb_use_deepseek', False)
        self.kb = KnowledgeBase(
            self.cfg.storage.db_path, "./data/kb",
            use_deepseek_embed=use_ds_embed,
            ds_api_key=self.cfg.llm.api_key if use_ds_embed else ""
        )
