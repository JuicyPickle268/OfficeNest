...
from PySide6.QtCore import Qt, QTimer, Signal, QThread, QStringListModel
...
class MotherPanelQt(QMainWindow):
    ...
    def _build_dashboard(self):
        ...
        self._pinned_file_input = QLineEdit()
    ...
    def _start_engine(self):
        ...
        if not self.cfg.llm.api_key:
            QMessageBox.warning(self, "缺少 API Key", "请先在 DeepSeek 配置页填写 API Key")
            return
        try:
        ...
        self._pinned_file_input.setEnabled(True)
        self._btn_pin.setEnabled(True)
        self._btn_unpin.setEnabled(True)
        self.cmd_input.setFocus()
        self._update_status("引擎", "● 运行中")
        self._log("INFO", f"引擎已启动 | {self.cfg.llm.model}")
    ...
    def _stop_engine(self):
        ...
        self._btn_unpin.setEnabled(False)
        self._update_status("引擎", "● 已停止")
    ...
    def _refresh_suggestions(self):
        ...
        for r in rows:
            ...
            item.setData(0, Qt.ItemDataRole.UserRole, r["id"])  # 隐藏 id
    ...
    def _build_settings(self):
        ...
        self._ds_model.setCurrentText(self.cfg.llm.model)
        ...
        self._s_kb_ds = QCheckBox("知识库用 DeepSeek Embedding（默认本地免费）")
        self._s_kb_ds.setChecked(getattr(self.cfg.llm, 'kb_use_deepseek', False))
        layout.addWidget(self._s_kb_ds)
    ...
    def _save_settings(self):
        self._up_yaml("llm", {
            ...
            "kb_use_deepseek": self._s_kb_ds.isChecked(),
